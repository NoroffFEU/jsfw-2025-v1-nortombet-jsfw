...
describe("Contact Page", () => {
  it("shows appropriate notifications on form submission", () => {
    ...
    expect(toast.success).toHaveBeenCalledWith("Your message has been sent successfully!", expect.anything());

    screen.getByTestId("error-button").click();
    expect(toast.error).toHaveBeenCalledWith("Please fix the errors in the form.", expect.anything());
  });
});
